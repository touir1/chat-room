...
CREATE TABLE IF NOT EXISTS friends (id INTEGER PRIMARY KEY AUTOINCREMENT, iduser INTEGER NOT NULL, idfriend INTEGER NOT NULL, UNIQUE(iduser,idfriend));
CREATE TABLE IF NOT EXISTS room_members (id INTEGER PRIMARY KEY AUTOINCREMENT, idroom INTEGER NOT NULL, idmember INTEGER NOT NULL, state CHARACTER(1) NOT NULL, UNIQUE(idroom,idmember)); -- state = {A = Accepted, W = Waiting, B = Banned}
